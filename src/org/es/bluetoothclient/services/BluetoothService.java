...
import static org.es.bluetoothclient.utils.IntentKey.MESSAGE_DEVICE_NAME;
import static org.es.bluetoothclient.utils.IntentKey.MESSAGE_READ;
import static org.es.bluetoothclient.utils.IntentKey.MESSAGE_TOAST;
import static org.es.bluetoothclient.utils.IntentKey.MESSAGE_WRITE;
import static org.es.bluetoothclient.utils.IntentKey.TOAST;
...
public class BluetoothService {
	...
	private static final UUID MY_UUID_SECURE	= UUID.randomUUID();//("fa87c0d0-afac-11de-8a39-0800200c9a66");
	private static final UUID MY_UUID_INSECURE	= UUID.randomUUID();//("8ce255c0-200a-11e0-ac64-0800200c9a66");
	...
	private synchronized void setState(int state) {
		...
		mHandler.obtainMessage(IntentKey.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
